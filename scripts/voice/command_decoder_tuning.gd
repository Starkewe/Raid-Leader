...
const MIN_LOW_CONFIDENCE_ACTION_SIMILARITY: float = 0.35
const MIN_DESTINATION_SIMILARITY: float = 0.46
const MIN_MERGED_SEQUENCE_SIMILARITY: float = 0.50
const MIN_EXACT_ACTION_MERGED_SIMILARITY: float = 0.68
const MIN_COLLAPSED_TERM_SIMILARITY: float = 0.55
const MIN_LOW_CONFIDENCE_WHO_IDENTITY_SCORE: float = 0.30
const MIN_LOW_CONFIDENCE_WHO_IDENTITY_MARGIN: float = 0.10
const MAX_ACTION_CAPABILITY_SPECIFICITY_BONUS: float = 0.04
const MIN_LOW_CONFIDENCE_DISTINCT_COMMAND_MARGIN: float = 0.01
